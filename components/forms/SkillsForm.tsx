import React, {
  ...
  const SkillsForm = ({
    ...
    const [skills, setSkills] = useState<SkillContent>({ skills: Array(6).fill("") });
    ...
    useEffect(() => {
      if (!pendingChangesRef.current) {
        ...
        setSkills({
          skills: [...contentSkills, ...Array(Math.max(6 - contentSkills.length, 0)).fill("")],
        });
    ...
    const handleColumnChange = useCallback((e: string) => {
